                           ...
                           children: [
                             Expanded(
                                 ...
                                 child: IconButton(onPressed: (){
                                   context.read<AddressBloc>().add(SelectAddressEvent(address.addressId));
                                 }, icon: state.selectedAddressId==address.addressId?
                                 Icon(Icons.check_box,color: mainGreen,):
                                 Icon(Icons.check_box_outline_blank,color: mainGreen))
                             ),
                             Expanded(
                               flex: 5,
                               child: Column(
