                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  color: total!=0?primaryColor:Colors.grey,
                                  child: Center(child: Text('Alış-verişi tamamla',
                                    style: TextStyle(
                                      color: total!=0?Colors.white:primaryTextColor,
                                      fontSize: 16,
...
class CartItemWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    bool isAvailable = (cartItem.sizeOption.isAvailable==true&&cartItem.colorOption.isAvailable==true);
    return Slidable(
        ...
        child: Row(
          children: [
            IconButton(
              ...
              icon: Icon(
                isAvailable?
                cartItem.isSelected ? Icons.check_box : Icons.check_box_outline_blank:Icons.block
              ),
            ),
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          BlocBuilder<FavoriteBloc, FavoriteStates>(
                            builder: (context, state) {
                              ...
                              if (state is FavoriteLoadedState) {
                                isFavorite = state.favorites.any((fav) => fav.productId == cartItem.productId);
                              }
                              return Icon(
                    ...
                    Text(
                      '${cartItem.sizeOption.price.toStringAsFixed(2)} AZN',
                      style: TextStyle(
                        color: primaryTextColor,
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                    ...
                    ):Text('Rəng və ya ölçü artıq əlçatan deyil',style: TextStyle(
                        color: Colors.red
                    ),),
                  ],
                ),
